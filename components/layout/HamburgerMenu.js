    ...
    <>
      ...
      <div className={`${styles.menuPanel} ${isOpen ? styles.menuOpen : ''}`}>
        ...
        <nav className={styles.mainNav}>
          ...
          <Link href="/courses" className={styles.mainLink} onClick={onClose}>Courses</Link>
        ...
        <div className={styles.socialIcons}>
          <a
            ...
            aria-label="Follow Somm.Site on Instagram"
          >
          ...
          <a
            ...
            rel="noopener noreferrer"
            className={styles.socialIconLink}
            aria-label="Follow Somm.Site on TikTok"
          >
            <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a
            ...
            rel="noopener noreferrer"
            className={styles.socialIconLink}
            aria-label="Follow Somm.Site on LinkedIn"
          >
            <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className={styles.searchSection}>
          <p className={styles.searchLabel}>Search Topics</p>
